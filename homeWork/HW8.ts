...
*/
function combineObjects<T, L>(obj1: T, obj2: L): T & L{
    return { ...obj1, ...obj2 };
}

const person = { name: 'Vyusal', lastName:'Naghiev', age: 24 };
const personalDetails = { city: 'Tiraspol', work:'developer' };

const mergedObj = combineObjects(person, personalDetails);
